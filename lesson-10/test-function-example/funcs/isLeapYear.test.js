/*
1. give year as integer.
2. Return true if year leap and false if not.
3. if give wrong data throw error with correct message.
...
describe("test isLeapYear function", ()=> {
    ...
    test("() - error 'year my be exist'", ()=> {
        expect(() => isLeapYear()).toThrow('year my be exist')
    })
